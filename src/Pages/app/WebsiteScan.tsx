...
import { FindingsList } from '@/components/app/Findings'
import { MethodChip, SeverityBadge } from '@/components/app/SeverityBadge'
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:py-8">
      <AnimatePresence mode="wait">
        {/* ───────── idle ───────── */}
        {phase === 'idle' && (
          <motion.div key="idle" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0, y: -8 }} className="mx-auto max-w-2xl pt-6 text-center sm:pt-12">
        ...
        {/* ───────── scanning ───────── */}
        {phase === 'scanning' && (
          <motion.div key="scan" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} className="grid grid-cols-1 gap-4 lg:grid-cols-12">
