  ...
  return (
          ...
          >
            ...
            <div className="flex flex-col-reverse gap-2 border-t border-white/8 px-5 py-4 sm:flex-row sm:justify-end">
              ...
              <Link href="/app/reports" onClick={onClose} className={cn('inline-flex h-10 items-center justify-center rounded-lg px-4 text-sm font-semibold ring-1 ring-white/10 hover:bg-white/5', !done && 'pointer-events-none opacity-40')}>
                Open in Reports
              </Link>
