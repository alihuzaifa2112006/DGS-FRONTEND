    ...
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:py-8">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        ...
        <div className="flex gap-2">
          <Link href="/app/api-tester" className="inline-flex h-10 items-center gap-2 rounded-lg bg-brand-600 px-4 text-[13.5px] font-semibold hover:bg-brand-500">
            <SendHorizontal size={15} /> New request
          </Link>
          <Link href="/app/website-scan" className="inline-flex h-10 items-center gap-2 rounded-lg bg-white/6 px-4 text-[13.5px] font-semibold ring-1 ring-white/10 hover:bg-white/10">
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-12">
        ...
        <motion.section initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="rounded-xl bg-ink-800 p-5 ring-1 ring-white/8 lg:col-span-4">
          ...
          <Link href="/app/reports" className="mt-5 inline-flex items-center gap-1 text-[13px] font-semibold text-brand-300 hover:text-brand-200">
        ...
        <motion.section initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35 }} className="overflow-hidden rounded-xl bg-ink-800 ring-1 ring-white/8 lg:col-span-12">
          <div className="flex items-center justify-between border-b border-white/8 px-5 py-4">
            ...
            <Link href="/app/reports" className="text-[13px] font-semibold text-brand-300 hover:text-brand-200">
              All reports →
            </Link>
          </div>
                ...
                {sampleReports.slice(0, 5).map((r) => (
                  <tr key={r.id} className="transition hover:bg-white/3 [&>td]:px-5 [&>td]:py-3">
                    ...
                    <td className="text-right">
                      <Link href="/app/reports" className="text-brand-300 hover:text-brand-200">
                        Open
                      </Link>
                    </td>
                  </tr>
